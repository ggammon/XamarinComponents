...
namespace SDWebImage
{
	...
	interface SDImageCache
	{
		...
		void StoreImage(UIImage image, string key, [NullAllowed]SDWebImageNoParamsHandler completionBlock);

		// -(void)storeImage:(UIImage *)image forKey:(NSString *)key toDisk:(BOOL)toDisk;
		[Export("storeImage:forKey:toDisk:completion:")]
		void StoreImage(UIImage image, string key, bool toDisk, [NullAllowed]SDWebImageNoParamsHandler completionBlock);

		// -(void)storeImage:(UIImage *)image recalculateFromImage:(BOOL)recalculate imageData:(NSData *)imageData forKey:(NSString *)key toDisk:(BOOL)toDisk;
		[Export("storeImage:recalculateFromImage:imageData:forKey:toDisk:completion:")]
		void StoreImage(UIImage image, bool recalculate, NSData imageData, string key, bool toDisk, [NullAllowed]SDWebImageNoParamsHandler completionBlock);
		...
		void DeleteOldFiles([NullAllowed]SDWebImageNoParamsHandler completion);
	...
	interface SDWebImageDownloader
	{
		...
		SDWebImageDownloadToken DownloadImage(NSUrl url, SDWebImageDownloaderOptions options, [NullAllowed] SDWebImageDownloaderProgressHandler progressBlock, [NullAllowed] SDWebImageDownloaderCompletedHandler completedBlock);
...
@property(nonatomic, strong, nullable) id downloadOperationCancelToken;
	...
	*/
	...
	interface SDWebImageDownloadToken
	{
		...
		[Export("downloadOperationCancelToken", ArgumentSemantic.Strong)]
...
y(assign, nonatomic) BOOL shouldDisableiCloud;
...
@property(assign, nonatomic) NSUInteger maxCacheSize;
	*/
	...
	{
		[Export("shouldDecompressImages")]
		bool ShouldDecrompressImage { get; set; }
